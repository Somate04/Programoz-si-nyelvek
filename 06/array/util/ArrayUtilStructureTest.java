...
public class ArrayUtilStructureTest {
    ...
    public static void init() {
        CheckThat.theClass("array.util.ArrayUtil")
            .thatIs(FULLY_IMPLEMENTED, INSTANCE_LEVEL, VISIBLE_TO_ALL); //INSTANCE_LEVEL: not static
    }
    ...
    public void methodMax() {
        it.hasMethodWithParams("max", "array of int") //név és parameter
            .thatIs(FULLY_IMPLEMENTED, USABLE_WITHOUT_INSTANCE, VISIBLE_TO_ALL) //static
            .thatReturns("int");
    }
